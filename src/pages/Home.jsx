  ...
  return (
    <div className="min-h-screen p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-sky-500 via-blue-600 to-orange-500 p-8 md:p-12 mb-8 shadow-2xl">
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl text-white/90 mb-6 max-w-2xl">
              Organiza torneos de beach vóley en Tel Aviv con equipos equilibrados por IA
            </p>
        ...
        {/* Tournaments List */}
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Mis Torneos</h2>
        </div>
        ...
        {isLoading ? (
          ...
          <Card className="border-2 border-dashed border-gray-300 bg-white/50">
            <CardContent className="flex flex-col items-center justify-center py-16">
              ...
              <p className="text-gray-600 mb-6 text-center max-w-md">
                Crea tu primer torneo de beach vóley y organiza equipos equilibrados automáticamente
              </p>
              <Link to={createPageUrl("CreateTournament")}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {tournaments.map((tournament) => {
              ...
              return (
                <Link key={tournament.id} to={createPageUrl(`TournamentDetail?id=${tournament.id}`)}>
